...
export async function generateMetadata() {
  ...
  return {
    ...
    description:
      "Explore a collection of blogs documenting coding challenges, solutions, and insights. Click on a blog to read more.",
    keywords: [
      "blogs",
      "coding",
      "solutions",
...
export default async function Blogs() {
  return (
    <div className="bg-gray-100 left-0 right-0 top-0 px-4">
